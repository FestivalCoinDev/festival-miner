...
constexpr size_t CRYPTONIGHT_FESTIVAL_MEMORY = 2 * 1024 * 1024;
constexpr uint32_t CRYPTONIGHT_FESTIVAL_MASK = CRYPTONIGHT_FESTIVAL_MEMORY - 16;
constexpr uint32_t CRYPTONIGHT_FESTIVAL_ITER = CRYPTONIGHT_FESTIVAL_MEMORY / 4;
...
template<>
inline constexpr size_t cn_select_memory<cryptonight_festival>() { return CRYPTONIGHT_FESTIVAL_MEMORY; }
...
inline size_t cn_select_memory(xmrstak_algo algo)
{
	...
	case cryptonight_festival:
		return CRYPTONIGHT_FESTIVAL_MEMORY;
	default:
		return 0;
	}
}
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_festival>() { return CRYPTONIGHT_FESTIVAL_MASK; }
...
inline size_t cn_select_mask(xmrstak_algo algo)
{
	...
	case cryptonight_festival:
		return CRYPTONIGHT_FESTIVAL_MASK;
	default:
		return 0;
	}
}
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_festival>() { return CRYPTONIGHT_FESTIVAL_ITER; }
...
inline size_t cn_select_iter(xmrstak_algo algo)
{
	...
	case cryptonight_festival:
		return CRYPTONIGHT_FESTIVAL_ITER;
	default:
		return 0;
	}
}
