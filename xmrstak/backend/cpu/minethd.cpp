...
bool minethd::self_test()
{
	...
	else if (::jconf::inst()->GetMiningAlgo() == cryptonight_festival)
	{
	}
...
minethd::cn_hash_fun minethd::func_selector(bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun func_table[] = {
		...
		cryptonight_hash<cryptonight_festival, false, false>,
		cryptonight_hash<cryptonight_festival, true, false>,
		cryptonight_hash<cryptonight_festival, false, true>,
		cryptonight_hash<cryptonight_festival, true, true>
	};
...
void minethd::work_main()
{
	...
	while (bQuit == 0)
	{
		...
		if (::jconf::inst()->GetMiningAlgo() == cryptonight_festival) new_version = oWork.bWorkBlob[1];
...
minethd::cn_hash_fun_multi minethd::func_multi_selector(size_t N, bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun_multi func_table[] = {
		...
		cryptonight_double_hash<cryptonight_festival, false, false>,
		cryptonight_double_hash<cryptonight_festival, true, false>,
		cryptonight_double_hash<cryptonight_festival, false, true>,
		cryptonight_double_hash<cryptonight_festival, true, true>,
		cryptonight_triple_hash<cryptonight_festival, false, false>,
		cryptonight_triple_hash<cryptonight_festival, true, false>,
		cryptonight_triple_hash<cryptonight_festival, false, true>,
		cryptonight_triple_hash<cryptonight_festival, true, true>,
		cryptonight_quad_hash<cryptonight_festival, false, false>,
		cryptonight_quad_hash<cryptonight_festival, true, false>,
		cryptonight_quad_hash<cryptonight_festival, false, true>,
		cryptonight_quad_hash<cryptonight_festival, true, true>,
		cryptonight_penta_hash<cryptonight_festival, false, false>,
		cryptonight_penta_hash<cryptonight_festival, true, false>,
		cryptonight_penta_hash<cryptonight_festival, false, true>,
		cryptonight_penta_hash<cryptonight_festival, true, true>
	};
